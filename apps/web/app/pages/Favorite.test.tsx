...
const unsortedFavoriteRouteStops: FavoriteRouteStop[] = [
  {
    ...
    city: CityNameType.TAIPEI,
    routeUID: 'route-2',
    routeName: { 'zh-TW': '藍2', en: 'Blue 20', ja: '', ko: '' },
    subRouteUID: 'subroute-2-1',
    subRouteName: {
      'zh-TW': '往市府轉運站',
      en: 'To City Hall Bus Station',
      ja: '',
      ko: '',
    },
    direction: DirectionType.GO,
    ...
    stopName: { 'zh-TW': '忠孝敦化', en: 'Zhongxiao Dunhua', ja: '', ko: '' },
    stopSequence: 2,
    departure: { 'zh-TW': '忠孝敦化', en: 'Zhongxiao Dunhua', ja: '', ko: '' },
    destination: {
      'zh-TW': '市府轉運站',
      en: 'City Hall Bus Station',
      ja: '',
      ko: '',
    },
  },
