...
This document explains how the `@bus/web` workspace is organized, how data flows through the frontend app, and which conventions to follow when adding or changing web features.

Paths in this document are relative to `apps/web/`. For example, `app/pages/` means `apps/web/app/pages/` from the repository root.
...
Keep `apps/web/README.md` focused on frontend product overview, setup, and usage. Small implementation conventions and team-facing coding notes should live in this file or code-local comments instead of being added to the README.
