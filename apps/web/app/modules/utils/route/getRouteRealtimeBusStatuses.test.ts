    ...
    const estimatedArrivals = [
      {
        ...
        StopUID: 'stop-2',
        StopID: 'stop-2',
        StopName: { 'zh-TW': '下一站', en: 'Next Stop', ja: '', ko: '' },
        RouteUID: 'route-1',
        RouteID: 'route-1',
        RouteName: { 'zh-TW': '藍1', en: 'Blue 1', ja: '', ko: '' },
        SubRouteUID: 'subroute-1',
    ...
    const realtimeBuses = [
      {
        ...
        RouteUID: 'route-1',
        RouteID: 'route-1',
        RouteName: { 'zh-TW': '225', en: '225', ja: '', ko: '' },
        SubRouteUID: 'route-1',
        SubRouteID: 'route-1',
        SubRouteName: { 'zh-TW': '225', en: '225', ja: '', ko: '' },
        Direction: DirectionType.GO,
        StopUID: 'stop-15',
        StopID: 'stop-15',
        StopName: {
          'zh-TW': '蘆洲監理站',
          en: 'Luzhou Motor Vehicles Office',
          ja: '',
          ko: '',
        },
        StopSequence: 15,
    ...
    const realtimeBuses = [
      {
        ...
        RouteUID: 'route-1',
        RouteID: 'route-1',
        RouteName: { 'zh-TW': '棕12', en: 'Brown 12', ja: '', ko: '' },
        SubRouteUID: 'subroute-1',
        SubRouteID: 'subroute-1',
        SubRouteName: { 'zh-TW': '棕12', en: 'Brown 12', ja: '', ko: '' },
        Direction: DirectionType.GO,
        StopUID: 'stop-current',
        StopID: 'stop-current',
        StopName: {
          'zh-TW': '捷運台電大樓站',
          en: 'MRT Taipower Building Station',
          ja: '',
          ko: '',
        },
        StopSequence: 10,
  ...
  it('uses the current stop status for the 225-style upstream shape when the bus is arriving', () => {
    ...
    const estimatedArrivals = [
      ...
      },
      {
        ...
        StopName: {
          'zh-TW': '格致中學(三和路)',
          en: 'Ger-Jyh Senior High School(Sanhe Rd.)',
          ja: '',
          ko: '',
        },
        RouteUID: 'TPE10443',
